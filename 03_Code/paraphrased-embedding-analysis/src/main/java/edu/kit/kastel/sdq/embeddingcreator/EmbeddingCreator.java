 ...
 * <p>
 * All embedding creators have access to a shared {@link edu.kit.kastel.sdq.context.ContextStore} via the protected {@code contextStore} field,
...
public abstract class EmbeddingCreator {
     ...
     */
    public Element calculateEmbedding(Element element) {
     ...
     */
    public abstract List<Element> calculateEmbeddings(List<Element> elements);
