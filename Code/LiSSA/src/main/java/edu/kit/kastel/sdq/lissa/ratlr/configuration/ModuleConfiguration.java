 ...
 */
public final class ModuleConfiguration extends Configuration {
    ...
    public <E extends Enum<E>> E argumentAsEnum(String key, int defaultIndex, E[] values) {
        String value = argumentAsString(key, "");
        if (!value.isEmpty()) {
