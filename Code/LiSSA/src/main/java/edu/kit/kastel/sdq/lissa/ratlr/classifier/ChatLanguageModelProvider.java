...
public class ChatLanguageModelProvider {
    ...
    /**
     * Creates a new chat language model provider with explicit parameters.
     * This constructor is used to construct ChatLanguageModelProvider instances without a {@link ModuleConfiguration}.
     *
     * @param name        The name of the ChatLanguageModelProvider::initializeModelProviders
     * @param model       The name of the model to use
     * @param seed        The seed value for randomization
     * @param temperature The temperature setting for the model
     * @see edu.kit.kastel.sdq.lissa.ratlr.preprocessor.ParaphrasePreprocessor#initializeModelProviders(ModuleConfiguration)
     */
    public ChatLanguageModelProvider(String name, String model, int seed, Double temperature) {
        this.platform = ChatLanguageModelPlatform.fromString(name);
     ...
     * @see CacheManager#getCache(Object, String[])
     */
