 ...
 * </ul>
 */
public abstract class ElementStore implements Context {

    /**
     * ID to be used if the ElementStore is used as a context.
     */
    ...
    /**
     * Creates an ElementStore for use as {@link Context}
     * @param id ContextId
     */
    protected ElementStore(String id) {
    ...
    /**
     * Creates a new element store with the provided content.
     * This constructor is used for initializing the store as a {@link Context} with existing elements and their embeddings.
     *
     * @param content List of pairs containing elements and their embeddings
     * @param id      Context ID of the context.
     */
    protected ElementStore(List<Pair<Element, float[]>> content, String id) {
        this.id = id;
        elementsWithEmbedding = new ArrayList<>();
        idToElementWithEmbedding = new HashMap<>();
    ...
    /**
     * Get the ID used when this ElementStore was initialized as a Context.
     * @return The ID of this ElementStore
     * @throws IllegalStateException If this ElementStore was not initialized as a Context.
     */
    public String getId() {
        return id;
    }
