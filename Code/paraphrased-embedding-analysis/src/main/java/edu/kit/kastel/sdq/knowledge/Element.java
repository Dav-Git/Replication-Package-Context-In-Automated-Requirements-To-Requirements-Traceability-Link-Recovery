...
package edu.kit.kastel.sdq.knowledge;
...
public final class Element extends Knowledge {
    ...
    /**
     * Copy constructor to create a new element from an existing one.
     *
     * @param other The element to copy
     */
    public Element(Element other) {
        super(other.getIdentifier(), other.getType(), other.getContent());
    ...
    public void setEmbedding(float[] embedding) {
        ...
        if (this.embedding == null) {
            ...
            throw new IllegalStateException("Embedding has already been set");
        }
    }
}
